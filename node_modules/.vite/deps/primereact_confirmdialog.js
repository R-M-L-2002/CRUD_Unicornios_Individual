...
var CSSTransition = React9.forwardRef(function(inProps, ref) {
...
var WindowMaximizeIcon = React11.memo(React11.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var WindowMinimizeIcon = React12.memo(React12.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React12.createElement("svg", _extends8({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var FocusTrap = import_react3.default.memo(import_react3.default.forwardRef(function(inProps, ref) {
  var targetRef = import_react3.default.useRef(null);
  var firstFocusableElementRef = import_react3.default.useRef(null);
  var lastFocusableElementRef = import_react3.default.useRef(null);
  var context = import_react3.default.useContext(PrimeReactContext);
  ...
  var createHiddenFocusableElements = function createHiddenFocusableElements2() {
    ...
    return import_react3.default.createElement(import_react3.default.Fragment, null, firstFocusableElement, props.children, lastFocusableElement);
  };
...
var Dialog = React13.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  ...
  var _React$useState = React13.useState(uniqueId), _React$useState2 = _slicedToArray6(_React$useState, 2), idState = _React$useState2[0];
  _React$useState2[1];
  var _React$useState3 = React13.useState(false), _React$useState4 = _slicedToArray6(_React$useState3, 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
  var _React$useState5 = React13.useState(false), _React$useState6 = _slicedToArray6(_React$useState5, 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
  var _React$useState7 = React13.useState(props.maximized), _React$useState8 = _slicedToArray6(_React$useState7, 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
  var dialogRef = React13.useRef(null);
  var maskRef = React13.useRef(null);
  var pointerRef = React13.useRef(null);
  var contentRef = React13.useRef(null);
  var headerRef = React13.useRef(null);
  var footerRef = React13.useRef(null);
  var closeRef = React13.useRef(null);
  var dragging = React13.useRef(false);
  var resizing = React13.useRef(false);
  var lastPageX = React13.useRef(null);
  var lastPageY = React13.useRef(null);
  var styleElement = React13.useRef(null);
  var attributeSelector = React13.useRef(uniqueId);
  var focusElementOnHide = React13.useRef(null);
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (props.closable) {
      ...
      var icon2 = props.closeIcon || React13.createElement(TimesIcon, closeButtonIconProps);
      ...
      return React13.createElement("button", closeButtonProps, headerCloseIcon, React13.createElement(Ripple, null));
    }
    return null;
  };
  var createMaximizeIcon = function createMaximizeIcon2() {
    ...
    if (!maximized) {
      icon2 = props.maximizeIcon || React13.createElement(WindowMaximizeIcon, maximizableIconProps);
    } else {
      icon2 = props.minimizeIcon || React13.createElement(WindowMinimizeIcon, maximizableIconProps);
    }
    ...
    if (props.maximizable) {
      ...
      return React13.createElement("button", maximizableButtonProps, toggleIcon, React13.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    if (props.showHeader) {
      ...
      return React13.createElement("div", headerProps, React13.createElement("div", headerTitleProps, header2), React13.createElement("div", headerIconsProps, icons, maximizeIcon, closeIcon));
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React13.createElement("div", contentProps, props.children);
  };
  var createFooter = function createFooter2() {
    ...
    return footer2 && React13.createElement("div", footerProps, footer2);
  };
  ...
  var createElement12 = function createElement13() {
    ...
    return React13.createElement(React13.Fragment, null, header2, content2, footer2, resizer);
  };
  var createDialog = function createDialog2() {
    ...
    var rootElement = React13.createElement("div", maskProps, React13.createElement(CSSTransition, _extends9({
      nodeRef: dialogRef
    }, transitionProps), React13.createElement("div", rootProps, React13.createElement(FocusTrap$1, {
...
var ConfirmDialog = React14.memo(React14.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React14.useContext(PrimeReactContext);
  var props = ConfirmDialogBase.getProps(inProps, context);
  var _React$useState = React14.useState(props.visible), _React$useState2 = _slicedToArray7(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React14.useState(false), _React$useState4 = _slicedToArray7(_React$useState3, 2), reshowState = _React$useState4[0], setReshowState = _React$useState4[1];
  var confirmProps = React14.useRef(null);
  var isCallbackExecuting = React14.useRef(false);
  var focusElementOnHide = React14.useRef(null);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React14.createElement(React14.Fragment, null, React14.createElement(Button, rejectButtonProps), React14.createElement(Button, acceptButtonProps));
  ...
  var createElement12 = function createElement13() {
    ...
    return React14.createElement(Dialog, _extends10({}, rootProps, {
      content: inProps === null || inProps === void 0 ? void 0 : inProps.content
    }), icon2, React14.createElement("span", messageProps, message));
  };
  var element = createElement12();
