...
var confirmDialog = function confirmDialog2() {
  ...
  var show = function show2() {
    ...
    OverlayService.emit("confirm-dialog", _objectSpread2(_objectSpread2(_objectSpread2({}, props), updatedProps), {
      visible: true
    }));
  };
...
var ConfirmDialog = React4.memo(React4.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React4.useContext(PrimeReactContext);
  var props = ConfirmDialogBase.getProps(inProps, context);
  var _React$useState = React4.useState(props.visible), _React$useState2 = _slicedToArray2(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React4.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), reshowState = _React$useState4[0], setReshowState = _React$useState4[1];
  var confirmProps = React4.useRef(null);
  var isCallbackExecuting = React4.useRef(false);
  var focusElementOnHide = React4.useRef(null);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React4.createElement(React4.Fragment, null, React4.createElement(Button, rejectButtonProps), React4.createElement(Button, acceptButtonProps));
  ...
  var createElement5 = function createElement6() {
    ...
    var icon = IconUtils.getJSXIcon(getPropValue("icon"), _objectSpread2({}, iconProps), {
      props: currentProps
    });
    var footer2 = createFooter();
    ...
    return React4.createElement(Dialog, _extends4({}, rootProps, {
      content: inProps === null || inProps === void 0 ? void 0 : inProps.content
    }), icon, React4.createElement("span", messageProps, message));
  };
